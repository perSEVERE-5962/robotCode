...
public final class Constants {
  ...
  public static final float Hor3 = 3;
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(186.59);
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(179.91);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(181.76);
  
    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 10;
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 11;
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 12;
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(358.95);
