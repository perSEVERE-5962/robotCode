...
public class TwoNoteAutonomous extends SequentialCommandGroup {
  ...
  public TwoNoteAutonomous(Shooter shooter, Intake feeder, Intake intake, Notification changeLight, SwerveSubsystem driveTrain, double rotationSpeed, double degreesWanted, double translationXSupplier, double distanceWanted, boolean checkForNote) {
