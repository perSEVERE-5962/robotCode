...
public class RunIntakeFeeder extends Command {
  ...
  public RunIntakeFeeder(Feeder feeder, Notification notification, Notification.NoteState notestate){
    this.intakefeeder = feeder;
    this.notification = notification;
    this.noteState = noteState;    // Use addRequirements() here to declare subsystem dependencies.
