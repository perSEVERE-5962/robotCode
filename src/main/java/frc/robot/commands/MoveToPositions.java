...
public class MoveToPositions extends SequentialCommandGroup {
  ...
  public MoveToPositions(SwerveSubsystem driveTrain, byte invert) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    /*
     * Forwards is negative, backwards is positive
    ...
    addCommands(
        ...
        new SidewaysDistance(driveTrain, 0.5 * invert, 28),
        ...
        */
        // Alt version: Move onto the charging station, checking pitch and slowing down each
        // interval.
