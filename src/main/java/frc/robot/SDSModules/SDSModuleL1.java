...
/** Add your docs here. */
public class SDSModuleL1 extends SDSModuleBase {
  private final double BACK_RIGHT_OFFSET = 0.472168;
  private final double BACK_LEFT_OFFSET = 0.051758;
  private final double FRONT_RIGHT_OFFSET = 0.028809;
  private final double FRONT_LEFT_OFFSET = 0.277588;

  private final double kPTurning = 0.34;
  private final double kITurning = 0.0;
  private final double kDTurning = 0.0;

  private final double kDriveMotorGearRatio = 1 / 8.14;
  ...
  private final double kPhysicalMaxSpeedMetersPerSecond = Units.feetToMeters(12.5);
