...
public class RevDrive extends DriveBase {
    ...
    RevDrive() {
         ...
         * 
         * The example below initializes brushless motors with MotorControllerDeviceID.
         * Change these parameters to match your setup
         */
        m_leftLeadMotor = new CANSparkMax(MotorControllerDeviceID.leftLeadDeviceID, MotorType.kBrushless);
        m_leftFollowerMotor = new CANSparkMax(MotorControllerDeviceID.leftFollowerDeviceID, MotorType.kBrushless);
        m_rightLeadMotor = new CANSparkMax(MotorControllerDeviceID.rightLeadDeviceID, MotorType.kBrushless);
        m_rightFollowerMotor = new CANSparkMax(MotorControllerDeviceID.rightFollowerDeviceID, MotorType.kBrushless);

        /**
         * The RestoreFactoryDefaults method can be used to reset the configuration
         * parameters in the SPARK MAX to their factory default state. If no argument 
        ...
        /**
         * create the encoders for each motor
         * each Neo brushless motor has it's own built-in encoder
         */
